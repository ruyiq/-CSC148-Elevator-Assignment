...
def test_random_moving_algorithm() -> None:
    ...
    config = {
        ...
        'arrival_generator': FileArrivals(2, 'sample_arrivals.csv'),
...
def test_pushy_passenger_moving_algorithm_0() -> None:
...
def test_pushy_passenger_moving_algorithm_2() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_2.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
    ...
    assert results['num_iterations'] == 10
    assert results['total_people'] == 3

    # Note: 3 of the 4 people completed their rides.
    # One sad person arrives at round 1 on floor 5, and never reaches their
    # target floor. :(
    assert results['people_completed'] == 3
    assert results['max_time'] == 5
    assert results['min_time'] == 1
    assert results['avg_time'] == 3
...
def test_pushy_passenger_moving_algorithm_4() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_4.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
    ...
    assert results['num_iterations'] == 10
    assert results['total_people'] == 9
    assert results['people_completed'] == 8
    assert results['max_time'] == 5
    assert results['min_time'] == 1
    assert results['avg_time'] == 3


def test_pushy_passenger_moving_algorithm_5() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_5.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
    ...
    assert results['total_people'] == 5
    assert results['people_completed'] == 5
    assert results['max_time'] == 7
    assert results['min_time'] == 2
    assert results['avg_time'] == 4


def test_pushy_passenger_moving_algorithm_6() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_6.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
    ...
    assert results['num_iterations'] == 10
    assert results['total_people'] == 2
    assert results['people_completed'] == 2
    assert results['max_time'] == 5
    assert results['min_time'] == 4
    assert results['avg_time'] == 4


def test_pushy_passenger_moving_algorithm_7() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_7.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
...
def test_pushy_passenger_moving_algorithm_8() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_8.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
...
def test_pushy_passenger_moving_algorithm_9() -> None:
    """Test the Pushy Passenger algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'test_algorithms_9.csv'),
        'moving_algorithm': PushyPassenger(),
        'visualize': False
    }
...
def test_short_sighted_moving_algorithm_0() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 2,
        'elevator_capacity': 1,
...
def test_short_sighted_moving_algorithm_2() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
    ...
    assert results['max_time'] == 5
    assert results['min_time'] == 1
    assert results['avg_time'] == 2


def test_short_sighted_moving_algorithm_3() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(5, 'short_sighted_3.csv'),
        'moving_algorithm': ShortSighted(),
        'visualize': False
    }
    sim = Simulation(config)
...
def test_short_sighted_moving_algorithm_4() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
    ...
    config = {
        ...
        # This is likely not used.
        'num_people_per_round': 2,
        'arrival_generator': FileArrivals(2, 'test_algorithms_4.csv'),
        'moving_algorithm': ShortSighted(),
        'visualize': False
    }
    sim = Simulation(config)
...
def test_short_sighted_moving_algorithm_5() -> None:
    """Test the Short-Sighted algorithm test with sample_arrivals.csv.
    ...
    assert results['num_iterations'] == 11
    assert results['total_people'] == 5
    assert results['people_completed'] == 5
    assert results['max_time'] == 8
    assert results['min_time'] == 1
...
def test_short_sighted_moving_algorithm_6() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 1,
        'elevator_capacity': 2,
...
def test_short_sighted_moving_algorithm_7() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 1,
        'elevator_capacity': 2,
...
def test_short_sighted_moving_algorithm_8() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 2,
        'elevator_capacity': 1,
...
def  test_short_sighted_moving_algorithm_9() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 1,
        'elevator_capacity': 4,
    ...
    assert results['total_people'] == 5
    assert results['people_completed'] == 5
    assert results['max_time'] == 10
    assert results['min_time'] == 1
    assert results['avg_time'] == 5


def  test_short_sighted_moving_algorithm_10() -> None:
    config = {
        'num_floors': 5,
        'num_elevators': 1,
        'elevator_capacity': 3,
